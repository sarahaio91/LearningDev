...
namespace ProjectionOperators
{
    class Program
    {
        ...
        {
            ProjectionExample obj = new ProjectionExample();
            //obj.LinQ6bis();
            //obj.LinQ7();
            //obj.LinQ8();
            //obj.LinQ9();
    ...
    public class ProjectionExample
    {
        ...
        public delegate void Plus(int i);
        ...
        public void LinQ6()
        {
            ...
            Array.ForEach(numbers, plusOne);
        }
        public void LinQ6bis()
        {
            int[] numbers = { 5, 4, 1, 3, 9, 8, 6, 7, 2, 0 };
            Array.ForEach(numbers, x => Console.WriteLine(x + 1));
        }
        ...
        public void LinQ7()
        {
            ...
            Array.ForEach(products, x => Console.WriteLine(x.Field<string>("ProductName")));
        }
        public void LinQ8()
        {
            int[] numbers = { 5, 4, 1, 3, 9, 8, 6, 7, 2, 0 };
            ...
            //1st way
            //Array.ForEach(numbers, x => Console.WriteLine(strings[x]));
            //2nd way
            //var k = numbers.Select(x => strings[x]);
            //foreach (var i in k)
            //{
            //    Console.WriteLine(i);
            //}
            //3rd way
            var k = from i in numbers
                    select strings[i];
            foreach (var i in k)
            {
                Console.WriteLine(i);
        ...
        public void LinQ9()
        {
            ...
            Array.ForEach(words, x => Console.WriteLine(x.ToUpper()));
            Array.ForEach(words, x => Console.WriteLine(x.ToLower()));
        }
        public void LinQ10()
        {
            int[] numbers = { 5, 4, 1, 3, 9, 8, 6, 7, 2, 0 };
