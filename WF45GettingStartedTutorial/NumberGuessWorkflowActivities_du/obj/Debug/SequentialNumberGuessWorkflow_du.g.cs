...
namespace NumberGuessWorkflowActivities {
    ...
    public partial class SequentialNumberGuessWorkflow : System.Activities.Activity, System.ComponentModel.ISupportInitialize {
...
partial void AfterInitializeComponent();
        ...
        public SequentialNumberGuessWorkflow() {
        ...
        public void InitializeComponent() {
            ...
            System.IO.Stream initializeXaml = typeof(SequentialNumberGuessWorkflow).Assembly.GetManifestResourceStream(resourceName);
            ...
            try {
                ...
                writerSettings.AccessLevel = System.Xaml.Permissions.XamlAccessLevel.PrivateAccessTo(typeof(SequentialNumberGuessWorkflow));
        ...
        private string FindResource() {
            string[] resources = typeof(SequentialNumberGuessWorkflow).Assembly.GetManifestResourceNames();
            for (int i = 0; (i < resources.Length); i = (i + 1)) {
                string resource = resources[i];
                if ((resource.Contains(".SequentialNumberGuessWorkflow_du.g.xaml") || resource.Equals("SequentialNumberGuessWorkflow_du.g.xaml"))) {
                    return resource;
                }
            }
