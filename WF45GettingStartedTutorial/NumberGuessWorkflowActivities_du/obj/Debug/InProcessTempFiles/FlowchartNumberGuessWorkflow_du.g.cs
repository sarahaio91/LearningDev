...
namespace NumberGuessWorkflowActivities {
    ...
    public partial class FlowchartNumberGuessWorkflow : System.Activities.Activity, System.ComponentModel.ISupportInitialize {
...
partial void AfterInitializeComponent();
        ...
        public FlowchartNumberGuessWorkflow() {
        ...
        public void InitializeComponent() {
            ...
            System.IO.Stream initializeXaml = typeof(FlowchartNumberGuessWorkflow).Assembly.GetManifestResourceStream(resourceName);
            ...
            try {
                ...
                writerSettings.AccessLevel = System.Xaml.Permissions.XamlAccessLevel.PrivateAccessTo(typeof(FlowchartNumberGuessWorkflow));
        ...
        private string FindResource() {
            string[] resources = typeof(FlowchartNumberGuessWorkflow).Assembly.GetManifestResourceNames();
            for (int i = 0; (i < resources.Length); i = (i + 1)) {
                string resource = resources[i];
                if ((resource.Contains(".FlowchartNumberGuessWorkflow_du.g.xaml") || resource.Equals("FlowchartNumberGuessWorkflow_du.g.xaml"))) {
                    return resource;
                }
            }
