...
namespace NumberGuessWorkflowActivities {
    ...
    public partial class StateMachineNumberGuessWorkflow : System.Activities.Activity, System.ComponentModel.ISupportInitialize {
        
        private bool _contentLoaded;
        
        private System.Activities.InArgument<int> _MaxNumber;
...
partial void AfterInitializeComponent();
        ...
        public StateMachineNumberGuessWorkflow() {
            this.InitializeComponent();
        }
        
        public System.Activities.InArgument<int> MaxNumber {
            get {
        ...
        public void InitializeComponent() {
            ...
            System.IO.Stream initializeXaml = typeof(StateMachineNumberGuessWorkflow).Assembly.GetManifestResourceStream(resourceName);
            ...
            try {
                ...
                writerSettings.AccessLevel = System.Xaml.Permissions.XamlAccessLevel.PrivateAccessTo(typeof(StateMachineNumberGuessWorkflow));
        ...
        private string FindResource() {
            string[] resources = typeof(StateMachineNumberGuessWorkflow).Assembly.GetManifestResourceNames();
            for (int i = 0; (i < resources.Length); i = (i + 1)) {
                string resource = resources[i];
                if ((resource.Contains(".StateMachineNumberGuessWorkflow_du.g.xaml") || resource.Equals("StateMachineNumberGuessWorkflow_du.g.xaml"))) {
                    return resource;
                }
            }
