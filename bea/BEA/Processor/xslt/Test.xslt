...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
  ...
  <xsl:template match="parametergrp | kenmerkgrp | a[text() = ' ' ]"/>
  ...
  <xsl:template match="commentaarcontent/verhandelingalgemeen">
    <div class="box">
      <xsl:apply-templates/>
    </div>
  </xsl:template>

  <xsl:template match="ablok[preceding-sibling::*[name() = 'ablok']][last()]">
    <p class="noindent1">
      <b>
  ...
  <xsl:template match="ablok/kopgeg/titel">
    <p class="h1">
